...
closeBtn.addEventListener("click",()=>{
    ...
    profile_pic.src = "img/pngtree-user-vector-avatar-png-image_1541962.jpg";
})
...
function registrationData(){
    ...
    swal("Good job!","Registration Sucessful!","success");
    ...
    for(i=0;i<allEdit.length;i++){
        allEdit[i].onclick = function(){
            ...
            updateBtn.onclick = function(e){
                ...
                registerForm.reset('');
                closeBtn.click();
                swal("Good job!","User data updated!","success");
            }
        }
    }
}
